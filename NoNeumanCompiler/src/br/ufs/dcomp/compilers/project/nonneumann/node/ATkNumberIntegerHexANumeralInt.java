...
public final class ATkNumberIntegerHexANumeralInt extends PANumeralInt
{
    private TTkNumberIntegerHex _tkNumberIntegerHex_;

    public ATkNumberIntegerHexANumeralInt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATkNumberIntegerHexANumeralInt(
    ...
    {
        ((Analysis) sw).caseATkNumberIntegerHexANumeralInt(this);
    }
