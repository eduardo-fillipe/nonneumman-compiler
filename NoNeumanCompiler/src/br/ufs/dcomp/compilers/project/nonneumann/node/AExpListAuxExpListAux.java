...
public final class AExpListAuxExpListAux extends PExpListAux
{
    private TTkSignComma _tkSignComma_;
    private PExp _exp_;

    public AExpListAuxExpListAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpListAuxExpListAux(
    ...
    {
        ((Analysis) sw).caseAExpListAuxExpListAux(this);
    }
