...
public final class ASignatureParameterSignature extends PParameterSignature
{
    private PSignature _signature_;

    public ASignatureParameterSignature()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASignatureParameterSignature(
    ...
    {
        ((Analysis) sw).caseASignatureParameterSignature(this);
    }
