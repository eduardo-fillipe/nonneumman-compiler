...
public final class ATkReservedBoolTrueBooleanValue extends PBooleanValue
{
    private TTkReservedBoolTrue _tkReservedBoolTrue_;

    public ATkReservedBoolTrueBooleanValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATkReservedBoolTrueBooleanValue(
    ...
    {
        ((Analysis) sw).caseATkReservedBoolTrueBooleanValue(this);
    }
