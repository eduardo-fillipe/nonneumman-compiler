...
public final class ADecConsAuxDecConsAux extends PDecConsAux
{
    private TTkSignParOpen _tkSignParOpen_;
    private PExp _exp_;
    private TTkSignParClose _tkSignParClose_;

    public ADecConsAuxDecConsAux()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecConsAuxDecConsAux(
    ...
    {
        ((Analysis) sw).caseADecConsAuxDecConsAux(this);
    }
