...
public final class AALambdaExpListAux extends PALambdaExpListAux
{
    private PAExp _aExp_;

    public AALambdaExpListAux()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAALambdaExpListAux(this);
    }
