...
public final class ASignatureAParameter extends PAParameter
{
    private PASignature _aSignature_;

    public ASignatureAParameter()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASignatureAParameter(
    ...
    {
        ((Analysis) sw).caseASignatureAParameter(this);
    }
