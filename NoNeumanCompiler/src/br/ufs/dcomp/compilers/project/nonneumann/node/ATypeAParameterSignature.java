...
public final class ATypeAParameterSignature extends PAParameterSignature
{
    private PAType _aType_;

    public ATypeAParameterSignature()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ATypeAParameterSignature(
    ...
    {
        ((Analysis) sw).caseATypeAParameterSignature(this);
    }
